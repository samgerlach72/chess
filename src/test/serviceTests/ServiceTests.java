...
public class ServiceTests {
    ...
    public void setup() {
        ...
        //registering user
        RegisterResponse response = RegisterService.register(existingUser);
        //obtaining authToken
    ...
    public void successLogin() {
        ...
        LoginResponse loginResult = LoginService.login(loginRequest);
    ...
    public void successRegisterUser() {
        RegisterResponse registerResult = RegisterService.register(newUser);
    ...
    public void registerTwice() {
        RegisterResponse registerResult = RegisterService.register(existingUser);
    ...
    public void successLogout() {
        ...
        LogoutResponse result = LogoutService.logout(existingAuth);
    ...
    public void failLogout() {
        ...
        LogoutService.logout(existingAuth);
        LogoutResponse result = LogoutService.logout(existingAuth);
    ...
    public void successCreate() {
        CreateGameResponse createResult = CreateGameService.createGame(createRequest, existingAuth);
    ...
    public void successJoin() {
        ...
        //try join
        JoinGameResponse joinResult = JoinGameService.joinGame(joinRequest, existingAuth);
        ...
        ListGamesResponse listResult = ListGamesService.listGames(existingAuth);
    ...
    public void badColorJoin() {
        ...
        JoinGameService.joinGame(joinRequest, existingAuth);
        ...
        JoinGameResponse joinResult = JoinGameService.joinGame(joinRequest, registerResult.getAuthToken());
    ...
    public void gamesList() {
        ...
        RegisterResponse userA = RegisterService.register(registerRequest);

        registerRequest = new RegisterRequest("b", "B", "b.B");
        RegisterResponse userB = RegisterService.register(registerRequest);

        //create games

        //1 as black from A
        createRequest = new CreateGameRequest("I'm numbah one!");
        CreateGameResponse game1 = CreateGameService.createGame(createRequest, userA.getAuthToken());
        JoinGameService.joinGame(new JoinGameRequest("BLACK", game1.getGameID()), userA.getAuthToken());

        //1 as white from B
        createRequest = new CreateGameRequest("Lonely");
        CreateGameResponse game2 = CreateGameService.createGame(createRequest, userB.getAuthToken());
        JoinGameService.joinGame(new JoinGameRequest("WHITE", game2.getGameID()), userB.getAuthToken());
        ...
        HashSet<Game> returnedList = ListGamesService.listGames(existingAuth).getGames();
    ...
    public void badAuthList() {
        ...
        //1 as black from A
        createRequest = new CreateGameRequest("I'm numbah one!");
        CreateGameService.createGame(createRequest, userA.getAuthToken());

        //1 as white from B
        createRequest = new CreateGameRequest("Lonely");
        CreateGameService.createGame(createRequest, userB.getAuthToken());
    ...
    public void clearSuccess() {
        ...
        ClearApplicationResponse clearResult = ClearApplicationService.clearApplication();
